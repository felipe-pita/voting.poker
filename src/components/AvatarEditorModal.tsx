...
const PowerByGiphy = styled("img")(({ theme }) => ({
...
export const AvatarEditorModal = ({
	...
	const room = useRoom();
	const [data, { updateField, updateFieldString }] = useFormControls(
